...
| `change` | `../web-orchestrator/references/iterate-lane-card.md`로 시작 — 정본은 `execution-contract.md`의 Iterate 루프 | **1-A ✋스팩 승인**(`change-lane-checkpoint.md`) — 사람 티켓 작업은 `specApproval: required`일 때만 |
| `fix` | 같은 카드·Iterate 루프, 1-A 건너뜀 | 유형별 보존 증거 |

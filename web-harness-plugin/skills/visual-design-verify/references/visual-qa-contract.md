...
`visual-contract-designer`는 사람이 읽는 `visual-qa-contract.md`와 machine-readable `visual-qa-contract.json`을 함께 만든다. JSON은 `web-harness-read schemas/visual-qa-contract.schema.json`을 따른다.

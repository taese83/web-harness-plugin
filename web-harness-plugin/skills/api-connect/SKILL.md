...
11. 변경 후 `test-writer`가 success/empty/malformed/timeout/auth/schema drift fixture를 보강하고 사용자 승인 후 `web-harness-script run-quality-gates --all --allow-host-execution`을 실행한다

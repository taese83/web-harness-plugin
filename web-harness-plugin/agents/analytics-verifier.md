...
source를 수정하지 않고 `_workspace/02_design/analytics-architecture.md`, current machine receipts와 구현을 비교해 `_workspace/04_qa/qa-analytics.md` 본문을 반환한다. 판정 기준은 `_workspace/.contracts/skills/analytics-chart-builder/references/`의 `analytics-test-matrix.md`·`semantic-query-contract.md`·`chart-compatibility.md`·`dashboard-editor-contract.md`다.

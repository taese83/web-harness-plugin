...
- **design readiness** (`_workspace/.contracts/skills/web-plan/references/design-readiness-contract.md`): 화면별 정보 위계 표·디자인 방향 절 존재, 고아 화면/고아 Must 기능(Feature List 매핑 누락), Primary 3개 초과 화면 — 위반은 `NEEDS_DECISION`

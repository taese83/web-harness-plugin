...
6. `web-harness-read skills/web-plan/references/planning-readiness-contract.md`에 따라 UX Check, critical state, annotation intent, 데이터 전략, 상대 노력도와 최소 검토 단위를 보존한다.

...
chart registry의 chart type ↔ 데이터 관계 호환성 판정은 `_workspace/.contracts/skills/web-orchestrator/references/design-principles-data-viz.md`의 차트 유형 선택 매트릭스를 기본 근거로 사용한다 (예: 구성비에 8개 범주 pie 비허용, 순위 bar는 정렬 필수, bar y축 0 시작).
